...
class QuestionRepositoryImpl(
    ...
    override fun getQuestionAnswer(id: Int): Flow<ApiResult<List<QuestionAnswer>>> = flow {
    ...
    override fun getQuestionById(id: Int): Flow<ApiResult<QuestionDetail>> = flow {
